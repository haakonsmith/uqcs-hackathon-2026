...
territory, `space`/`p` place troops, `c` clears the plan, `f` says you are
finished with the phase and `tab` shows the scoreboard.

Placing is the only way troops reach the board, and it does not happen as you
ask for it. They go on your own ground, or on ground touching it - the first
reinforces, the second assaults. Placements are secret until the phase ends -
your own show as a `(+n)` beside the garrison they will join - and then they
all land together, with the biggest stack in a territory taking it and losing
as many troops as the next biggest had.
